...
<div class="about-timeline">
  <div class="about-timeline-item">
    <div class="about-timeline-org"><strong>Shinshu University</strong></div>
    <div class="about-timeline-detail">
...
- **Embedded / Camera**: RTOS, linker script, image sensor control, camera pipeline, NPU input preprocessing
- **ML / Deployment**: PyTorch, TensorFlow, ONNX, quantization, knowledge distillation
- **HW / Debug**: JTAG, oscilloscope, protocol analyzer
