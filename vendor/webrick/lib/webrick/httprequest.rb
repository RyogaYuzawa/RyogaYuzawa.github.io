...
module WEBrick
  ...
  class HTTPRequest
    ...
    def read_chunked(socket, block)
      ...
      read_chunked_trailer(socket)
      @header.delete("transfer-encoding")
      @remaining_size = 0
    end

    # Discard trailer fields instead of reparsing them into @header.
    def read_chunked_trailer(socket)
      loop do
        line = read_line(socket)
        raise HTTPStatus::BadRequest, "premature EOF in trailer." if line.nil?
        break if line == "\r\n"
      end
    end
